package com.fileuploader.app.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.fileuploader.app.service.EmailAlreadyUsedException ||
            ex instanceof com.fileuploader.app.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.fileuploader.app.service.InvalidPasswordException
